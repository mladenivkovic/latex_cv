...
\section{Software}
    ...
    \explanationdetail{\coloredbullet\ %
        Major contributions to \ramses\ and \swift\ open source astrophysical high performance
        simulation codes. 
    }
    \explanationdetail{\coloredbullet\ %
...
\section{Publications}
    \newcommand{\publicationone}{%
        ...
        \href{https://ui.adsabs.harvard.edu/abs/2022MNRAS.510..959I/abstract}{ACACIA: a new method to produce on-the-fly merger trees in the RAMSES code}, 
